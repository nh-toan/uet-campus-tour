...
export const introContent = {
  context: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Trong nước',
        paragraphs: [
          'Sau hơn 35 năm đổi mới và hội nhập quốc tế, kinh tế, xã hội, khoa học công nghệ của nước ta đã có những thay đổi vượt bậc. Tuy nhiên, chúng ta đang phải đương đầu với các thách thức cốt lõi như chất lượng nguồn nhân lực, trình độ phát triển của khoa học công nghệ, chất lượng tăng trưởng kinh tếxã hội. Đại hội 13 của Đảng tiếp tục xác định phát triển nguồn nhân lực, nhất là nguồn nhân lực chất lượng cao là một đột phá chiến lược, là yếu tố quyết định đẩy mạnh phát triển và ứng dụng khoa học, công nghệ, cơ cấu lại nền kinh tế, chuyển đổi mô hình tăng trưởng và là lợi thế cạnh tranh quan trọng nhất, bảo đảm cho phát triển nhanh, hiệu quả và bền vững. Phát triển khoa học công nghệ cùng với việc nâng cao chất lượng nguồn nhân lực được xác định là yếu tố then chốt để đưa kinh tế iệt Nam vượt qua những yếu kém hiện tại, tiến tới xây dựng nền kinh tế tri thức.',
  ...
  missionVision: {
    id: 'mission-vision',
    label: 'Sứ mạng, tầm nhìn và giá trị cốt lõi',
    sections: [
      {
        id: 'mission',
        title: 'Sứ mạng',
      ...
      {
        id: 'core-values',
        title: 'Giá trị cốt lõi và Khẩu hiệu hành động',
        paragraphs: [
          '– Giá trị cốt lõi:',
  ...
  keyTasks: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Tổ chức, đội ngũ và quản trị đại học',
        items: [
...
export const introTabs = [introContent.context, introContent.missionVision, introContent.keyTasks];
